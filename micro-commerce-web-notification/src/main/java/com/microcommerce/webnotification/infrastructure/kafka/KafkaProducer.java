package com.microcommerce.webnotification.infrastructure.kafka;
...
public class KafkaProducer {
    ...
    public void send(final String topic, final Object message) {
        final CompletableFuture<SendResult<String, Object>> future = kafkaTemplate.send(topic, message);
